        ...
        <div className="flex items-center gap-2">
          ...
          {userPlan !== "pro" && (
            <PricingModal reason="upgrade">
              <span className="inline-flex items-center gap-1 rounded-full border border-blue-500/30 bg-blue-500/10 px-2 py-0.5 text-[11px] font-medium text-blue-400 cursor-pointer hover:bg-blue-500/20 hover:border-blue-500/50 transition-all">
